...
public func UIGraphicsGetCurrentContext() -> Silica.CGContext? {
    
    return ContextStack.last
}

/// Makes the specified graphics context the current context.
public func UIGraphicsPushContext(_ context: Silica.CGContext) {
...
private var ContextStack: [Silica.CGContext] = []
